        ...
        <form method="POST" action="?/login">
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-3/4 mx-auto px-3">
                    <button
                        type="submit"
                        class="w-full bg-black hover:bg-yellow-400 text-white font-bold py-2 rounded"
                    >
                        Login
                    </button>
                </div>
        ...
        <form method="POST" action="?/pay">
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-3/4 mx-auto px-3">
                    <button
                        type="submit"
                        class="w-full font-bold py-2 rounded  bg-black hover:bg-yellow-400 text-white" 
                    >
                        Pay
                    </button>
                </div>
